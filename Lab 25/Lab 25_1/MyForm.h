...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Text = L"Скрыть текст";
			...
			this->radioButton2->Text = L"Технология";
			...
			this->textBox3->Text = L"Корень из частного";
			// 
			// button5
			// 
			...
			this->label2->Text = L"Перевод литров в бочки";
			...
			this->textBox5->Text = L"Результат";
			// 
			// button8
			// 
...
private: System::Void radioButton1_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Text = "Приложение Шуста Е.А. (С)2022";
}
...
private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	this->textBox2->Clear();
	this->textBox3->Clear();
	this->textBox3->Text = "Корень из частного";
}
...
private: System::Void button7_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		if (c <= 0) {
			MessageBox::Show("Некорректное количество литров");
		}
		else {
			double d = (c / 491.96);
			this->textBox5->Clear();
